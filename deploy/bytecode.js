...
async function main() {
    ...
    const exchangeBytecode = await getbytecode(compiledContracts, 'SentinelExchange.sol:SentinelExchange', [
        '0x574366e84f74f2e913ad9a6782ce6ac8022e16eb',
    ...
    const oracleBytecode = await getbytecode(compiledContracts, 'Oracle.sol:Oracle', [
        '0x574366e84f74f2e913ad9a6782ce6ac8022e16eb',
