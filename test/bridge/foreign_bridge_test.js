...
contract('ForeignBridge_ERC20_to_ERC20', async (accounts) => {
  ...
  describe('#initialize', async () => {
    it('should initialize', async () => {
      token = await SencToken.new("Some ERC20", "RSZT", 18);
  ...
  describe('#withdraw with 2 minimum signatures', async () => {
    ...
    it('works with 5 validators and 3 required signatures', async () => {
      ...
      const erc20Token = await SencToken.new("Some ERC20", "RSZT", 18);
  ...
  describe('#upgradeable', async () => {
    it('can be upgraded', async () => {
      ...
      let token = await SencToken.new("Some ERC20", "RSZT", 18);
  ...
  describe('#claimTokens', async () => {
    it('can send erc20', async () => {
      ...
      let tokenSecond = await SencToken.new("Roman Token", "RST", 18);
